...
public class TestPoint {
   public static void main(String[] args) {
      ...
      p2.setXY(10, 11);
      System.out.printf("Jaraknya adalah: %.2f%n", p1.distance(10, 11));
      //Distance is: 7.07
      System.out.printf("Jaraknya adalah: %.2f%n", p1.distance(p2));
      //Distance is: 7.07
      System.out.printf("Jaraknya adalah: %.2f%n", p2.distance(p1));
      //Distance is: 7.07
      System.out.printf("Jaraknya adalah: %.2f%n", p1.distance());
      //Distance is: 7.81
   }
}
