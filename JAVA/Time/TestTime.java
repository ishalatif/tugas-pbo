...
public class TestTime {
   public static void main(String[] args) {
      ...
      t1.setMinute(5);
      t1.setSecond(6);
      System.out.println(t1);  // run toString() untuk memeriksa contoh yang dimodifikasi
      //04:05:06
      System.out.println("Jamnya adalah: " + t1.getHour());
      //Hour is: 4
      System.out.println("Menitnya adalah: " + t1.getMinute());
      //Minute is: 5
      System.out.println("Detiknya adalah: " + t1.getSecond());
      //Second is: 6
